      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
          {Object.entries(footerSections).map(([title, links]) => (
            <div key={title}>
              <h3 className="font-semibold text-apple-gray text-sm mb-3">{title}</h3>
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-xs text-apple-text-gray hover:text-apple-gray transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="border-t border-gray-300 pt-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-apple-text-gray">
            <a href="#" className="hover:text-apple-gray transition-colors">Privacy Policy</a>
            <span>|</span>
            <a href="#" className="hover:text-apple-gray transition-colors">Terms of Use</a>
            <span>|</span>
            <a href="#" className="hover:text-apple-gray transition-colors">Sales and Refunds</a>
            <span>|</span>
            <a href="#" className="hover:text-apple-gray transition-colors">Legal</a>
            <span>|</span>
            <a href="#" className="hover:text-apple-gray transition-colors">Site Map</a>
